...
if len(existing_vols) > 0:
    ...
    if vol.attach_data.instance_id == instance:
        ...
        os.system("mount {} {}}".format(args.device, args.mountpoint))
        print "Attached volume {} to device {} on instance {} mount point {}".format(args.volumeid, args.device, instance, args.mountpoint)
        sys.stdout.flush()
else:
